            ...
            <div class="flex items-center justify-between h-16">
                <div class="flex items-center space-x-8">
                    ...
                    <div class="hidden md:flex items-center space-x-1">
                        ...
                        <a href="{{ route('fill_text.form') }}" class="px-3 py-2 rounded-md text-sm font-medium hover:bg-slate-700 transition {{ request()->routeIs('fill_text.form') || request()->routeIs('fill_text.result_view') || request()->routeIs('fill_text.show') ? 'bg-slate-700' : '' }}">Fill Text</a>
                        <a href="{{ route('fill_text.subtype.form') }}" class="px-3 py-2 rounded-md text-sm font-medium hover:bg-slate-700 transition {{ request()->routeIs('fill_text.subtype.*') ? 'bg-slate-700' : '' }}">Subtype Fill</a>
